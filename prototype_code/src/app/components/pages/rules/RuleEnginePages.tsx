...
export function RuleCategoryListPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold text-foreground">{t("rules.categoriesTitle")}</h1>
        <p className="mt-1 text-sm text-muted-foreground">{t("rules.categoriesHelp")}</p>
      </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {(categoriesQuery.data ?? []).map((category) => (
            <button
              ...
              className="flex min-h-44 flex-col gap-4 rounded-lg border border-border bg-card p-5 text-left shadow-sm transition hover:border-blue-300 hover:bg-blue-50/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2"
            >
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
        <div>
          <h1 className="text-2xl font-semibold text-foreground">{t("rules.listTitle")}</h1>
          <p className="mt-1 text-sm text-muted-foreground">{t("rules.listHelp")}</p>
        </div>
        {isSuperAdmin && (
          <Button asChild>
            <Link to="/rules/new">
                        ...
                        <TableRow key={rule.id}>
                          <TableCell>
                            <div className="flex flex-col gap-1">
                              ...
                              {rule.description && <span className="max-w-xs truncate text-xs text-muted-foreground">{rule.description}</span>}
                            </div>
                          </TableCell>
                          <TableCell>
                          ...
                          <TableCell>
                            <div className="flex max-w-sm flex-col gap-1 font-mono text-xs">
                              ...
                              <span className="truncate text-muted-foreground">{rule.value || "-"}</span>
                            </div>
                          </TableCell>
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">{t("rules.formHelp")}</p>
        </div>
