...
- Name: critical-flows.spec.js >> operator can persist a harmless system reason option through the UI
- Location: tests/e2e/critical-flows.spec.js:48:1
...
Locator: getByRole('heading', { name: 'System Configuration' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'System Configuration' })
