...
- Name: critical-flows.spec.js >> OpenAPI keeps completed module routes available
- Location: tests/e2e/critical-flows.spec.js:65:1
...
Expected value: "/api/v1/ai/providers"
Received array: ["/health", "/api/v1/health/qdrant", "/api/v1/auth/me", "/api/v1/auth/login", "/api/v1/rules/categories", "/api/v1/rules", "/api/v1/rules/evaluate", "/api/v1/rules/{rule_id}", "/api/v1/rules/{rule_id}/toggle", "/api/v1/product-names", …]
```
