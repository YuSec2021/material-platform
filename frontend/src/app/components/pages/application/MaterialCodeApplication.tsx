...
export function MaterialCodeApplication() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <div className="rounded-lg bg-primary/10 px-3 py-2 text-sm font-medium text-primary">{generatedMaterialName}</div>
            </div>
          </div>
              ...
              {[0, 1, 2].map((slot) => (
                ...
                >
                  ...
                  <span className="text-xs text-muted-foreground">
                    图片 {slot + 1} <span className="text-destructive">*</span>
      ...
      {feedback && <div role="status" className="rounded-lg border border-primary/30 bg-primary/10 p-3 text-sm text-foreground">{feedback}</div>}
