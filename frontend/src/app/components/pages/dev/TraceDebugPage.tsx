  ...
  return (
    <div className="space-y-6">
      ...
      {traceQuery.isLoading ? (
        <div className="grid gap-4 lg:grid-cols-[minmax(280px,380px)_minmax(0,1fr)]" aria-label="AI trace loading" aria-busy="true">
        ...
        <div className="rounded-lg border border-warning/40 bg-warning/10 p-6 text-sm text-foreground" role="status">
              ...
              <div className="space-y-3 rounded-md border border-border bg-muted/30 p-3">
                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                  <div className="space-y-1">
                    <Label htmlFor="trace-start-date" className="text-xs text-muted-foreground">开始日期 / Start date</Label>
                    <Input
                      id="trace-start-date"
                      type="date"
                  ...
                  <div className="space-y-1">
                    <Label htmlFor="trace-end-date" className="text-xs text-muted-foreground">结束日期 / End date</Label>
                    <Input
                      id="trace-end-date"
                      type="date"
                      value={endDateDraft}
                ...
                {filteredTraces.map((trace) => {
                  ...
                  return (
                    <Button
                      ...
                      className={cn(
                        "h-auto w-full flex-col items-stretch gap-0 whitespace-normal rounded-md p-3 text-left",
                        selected
