        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {(categoriesQuery.data ?? []).map((category) => (
            <Button
              ...
              className="h-auto min-h-44 flex-col items-stretch justify-start gap-4 whitespace-normal p-5 text-left shadow-sm hover:border-primary/30 hover:bg-primary/5"
            >
    ...
    <div className="flex flex-col gap-6">
      ...
      >
        <Card>
          ...
          <CardContent>
            <form className="grid gap-5 lg:grid-cols-2" onSubmit={handleSubmit} noValidate aria-busy={saveMutation.isPending}>
