...
function MappingDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl" aria-busy={isSaving}>
        <DialogHeader>
...
export function CapabilityMappingPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {noModels && (
        <div className="rounded-lg border border-dashed border-warning/40 bg-warning/10 p-5 text-sm text-warning-foreground">
